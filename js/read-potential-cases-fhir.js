...
(async () => {
  ...
  await fs.writeFile("congenital-anomalies-in-children-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("congenital-anomalies-in-children-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
